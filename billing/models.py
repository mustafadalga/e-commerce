...
stripe.api_key = "sk_test_53qdSBhMf6DpdVhkomQzAkSD00t9IcQotu"  # Secret key
...
class BillingProfile(models.Model):
    ...
    # Misafir kullanıcı ise kart bilgileri bir sonraki sefer için tutulmaz
...
# Kullanıcı hesabı oluşturulduğu anda ,bir fatura kimliği oluşturur.
post_save.connect(user_created_receiver, sender=User)



class CardManager(models.Manager):
    def all(self,*args,**kwargs): # ModelClass.objects.all() --> ModelClass.objects.filter(active=True)
...
# Yeni kart eklendiğinde kullanıcı profilinin diğer kartlarını default değeri False ayarla.
